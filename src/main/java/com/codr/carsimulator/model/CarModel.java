...
public class CarModel {
    ...
    public CarData nextValue() {
        ...
        final CarData nextModel = CarData.builder()
                ...
                .speed(speed)
                .engineVibrationAmplitude(engineVibrationAmplitude)
                // Accelerometer
                .accelerometer11Value(accelerometerValue1)
                .accelerometer12Value(accelerometerValue2)
                .accelerometer21Value(accelerometerValue3)
                .accelerometer22Value(accelerometerValue4)
                // Tire pressure
                .tirePressure11(tirePressure1)
                .tirePressure12(tirePressure2)
                .tirePressure21(tirePressure3)
                .tirePressure22(tirePressure4)
                // Battery
                .batteryPercentage(prevBatteryPercentage)
                .batteryVoltage(batteryVoltage)
                .coolantTemp(coolantTemp)
                .currentDraw(currentDraw)
                .controlUnitFirmware(firmwareVersion)
                // Basic failure mode labelling
                .failureOccurred(failureOccurred ? "true" : "false")
                .build();
